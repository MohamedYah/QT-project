...
public:
    Clientele();
    Clientele(QString Prenom,QString Nom,QString Num_Tel,QString CIN,QString Adresse,int ID,int ID_client,int Age,QString Date_N,QString Date_D,QString Date_F,QString Taille,QString Poids,int Number);
