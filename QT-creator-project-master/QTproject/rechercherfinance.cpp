...
#include "ui_rechercherfinance.h"
#include <QPalette>
#include <QDesktopWidget>
#include <QtGui>
#include"menuprincipale.h"

rechercherfinance::rechercherfinance(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::rechercherfinance)
{
    ui->setupUi(this);
...
rechercherfinance::~rechercherfinance()
{
    delete ui;
}

void rechercherfinance::on_RFprecedentPB_clicked()
{
    this->hide();
